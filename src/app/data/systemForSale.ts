...
Admins have access to a centralized dashboard where they can monitor all business activities and user contributions. They also handle revenue management, earning a percentage from every sale made through the platform.
...

    {
      ...
      images: ["/system_preview/reviewersystem (1).png",, "/system_preview/reviewersystem (2).png", "/system_preview/reviewersystem (3).png", "/system_preview/reviewersystem (4).png",, "/system_preview/reviewersystem (5).png", "/system_preview/reviewersystem (6).png", "/system_preview/reviewersystem (7).png", "/system_preview/reviewersystem (8).png", "/system_preview/reviewersystem (9).png", "/system_preview/reviewersystem (11).jpg",  ],
      information : `
